...
const newPackage = Object.assign(
  {},
  packageContents,
  packagingConfig.packageUpdates || {} // Ensure it defaults to an empty object if undefined
);

// Remove packaging field after updates
delete newPackage.packaging;

// Log the contents of the new package for debugging purposes
logger('New package contents:', newPackage);

// Write the updated package.json
logger('Writing the new package.json file.');
...
if (vsixFiles.length !== 1) {
  console.error('unable to find generated vsix file.');
  process.exit(2);
}
